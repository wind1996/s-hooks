...
export class Totp {
  ...
  base32tohex(base32) {
    let base32chars; let bits; let chunk; let hex; let i; let
      val;
  ...
  getOtp(secret, now = new Date().getTime()) {
    let epoch; let hmac; let key; let offset; let otp; let shaObj; let
      time;
...
export class Hotp {
  ...
  getOtp(key, counter) {
    let digest; let h; let offset; let shaObj; let
      v;
